      ...
      if (
        ...
        for (let j = 0; j < this.sizeX; j++) {
          for (let k = 0; k < this.sizeY; k++) {
            if (
              Map[k + this.location[0]][j + this.location[1]].label == "Floor"
            ) {
              PlacingError = true;
            } else {
              if (
                Map[k + this.location[0]][j + this.location[1]].label == "Wall"
              ) {
                PlacingError = true;
              }
            }
        ...
        if (PlacingError == true) {
          ...
          for (let i = 0; i < this.sizeX + 1; i++) {
            ...
            Map[this.location[0] + this.sizeY - 1][this.location[1] + i] =
          ...
          for (let i = 1; i < this.sizeY - 1; i++) {
            ...
            Map[this.location[0] + i][this.location[1] + this.sizeX] = new Tile(
              "Wall",
              "#806000",
              "#",
              8,
            ...
            for (let j = 1; j < this.sizeX; j++) {
              Map[this.location[0] + i][this.location[1] + j] = new Tile(
                "Floor",
                "#202020",
                "-",
                0.3,
          ...
          for (let i = 0; i < 2; i++) {
            for (let j = 0; j < 2; j++) {
              ...
              ] = new Tile("Corner", "#806000", "X", 99, "Corner" + CornerType);
            }
          }
          return Map;
        }
